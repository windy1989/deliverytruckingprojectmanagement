        ...
        <div class="row layout-top-spacing" id="cancel-row">
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <h5>Detail Klaim Pembelian <b>{{ $repayment->code }}</h5>
                        </div>
                    </div>
                    @if($repayment->claims)
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="flag" id="flag" class="form-control" required {{ $repayment->claims ?
                                    'disabled' : 'required' }}>
                                    <option value="1" {{ $repayment->claims ? $repayment->claims->flag == 1 ? 'selected'
                                        : '' : '' }}>Berat</option>
                                    <option value="2" {{ $repayment->claims ? $repayment->claims->flag == 2 ? 'selected'
                                        : '' : '' }}>Qty</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group text-right">
                        <a href="{{ url('report/purchase') }}" class="btn btn-secondary">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
