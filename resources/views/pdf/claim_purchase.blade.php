                            ...
                            <div class="col-md-12 text-right">
                                <div class="row justify-content-end">
                                    <div class="col-md-8 text-left">
                                        <h4 class="mt-2">Cetak Klaim Pembelian</h4>
                                    </div>
                                    <div class="col-md-2">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    @php
                                                        ...
                                                        $claim_total_late    = 0;
                                                    @endphp
                                                    @foreach($claim->claimable->repaymentDetail as $rd)
                                                        @php
                                                            ...
                                                            <tr class="claim_body_late text-center">
                                                                @php
                                                                    if($claim->claimable->flag == 1) {
                                                                        $calculate_by = $rd->letterWay->weight;
                                                                    } else {
                                                                        $calculate_by = $rd->letterWay->qty;
                                                                    }

                                                                    if($rd->letterWay->destination->destinationPrice->last()) {
                                                                        $price        = $rd->letterWay->destination->destinationPrice->last();
                                                                        $price_vendor = $price->price_vendor;
                                                                    } else {
                                                                        $price_vendor = 0;
                                                                    }

                                                                    $percentage = $claim_detail ? $claim_detail->percentage : 0;
                                                                    $total      = $total_late * ($calculate_by * $price_vendor) * ($percentage / 100);
                                                                @endphp
                                                                <td class="align-middle" colspan="3">{{ $rd->letterWay->number }}</td>
                                                        ...
                                                        @else
                                                            <tr class="claim_body_clean">
                                                                <td class="align-middle text-left" colspan="6">{{ $rd->letterWay->number }}</td>
                                                            </tr>
                                                        @endif
                                                    @endforeach
                                                </tbody>
