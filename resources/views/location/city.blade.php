<div id="content" class="main-content">
                    ...
                    <p class="modal-text">
                        ...
                        <form id="form_data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="latitude" id="latitude" class="form-control" placeholder="Masukan latitude">
                            </div>
                            <div class="form-group">
                                <label>Latitude :</label>
                                <input type="text" name="longitude" id="longitude" class="form-control" placeholder="Masukan longitude">
                            </div>
                        </form>
                    </p>
                </div>
    ...
    <script>
        $(function() {
            loadDataTable();
            select2ServerSide('#province_id', '{{ url("select2_serverside/province") }}', '#form_modal');
        });
        ...
        function loadDataTable() {
            $('#datatable_serverside').DataTable({
                ...
                columns: [
                    ...
                    { name: 'latitude', searchable: false, className: 'text-center align-middle' },
                    { name: 'longitude', searchable: false, className: 'text-center align-middle' },
        ...
        function show(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    loadingClose('.modal-content');
                    $('#province_id').append(`<option value="` + response.province_id + `" selected>` + response.province_name + `</option>`);
