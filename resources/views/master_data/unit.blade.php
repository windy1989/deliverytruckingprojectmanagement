                        ...
                        <form id="form_data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control">
                                    ...
                                    <option value="1">Satuan Harga Per Tujuan</option>
                                    <option value="2">Satuan Qty Order</option>
                                </select>
                            </div>
                        </form>
                    </p>
    ...
    <script>
        ...
        function loadDataTable() {
            $('#datatable_serverside').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: '{{ url("master_data/unit/datatable") }}',
                    type: 'POST',
                    headers: {
        ...
        function create() {
            $.ajax({
                url: '{{ url("master_data/unit/create") }}',
                type: 'POST',
                dataType: 'JSON',
        ...
        function update(id) {
            $.ajax({
                url: '{{ url("master_data/unit/update") }}' + '/' + id,
                type: 'POST',
                dataType: 'JSON',
                data: $('#form_data').serialize(),
                headers: {
        ...
        function destroy(id) {
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        url: '{{ url("master_data/unit/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
