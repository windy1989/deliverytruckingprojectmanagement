                    ...
                    <p class="modal-text">
                        ...
                        <form id="form_data">
                            <div class="form-group">
                                <label>Nama :</label>
                                <input type="text" name="name" id="name" class="form-control" placeholder="Masukan nama gudang">
                            </div>
                            <div class="form-group">
                                <label>Kode :</label>
                                <input type="text" name="code" id="code" class="form-control" placeholder="Masukan kode">
                            </div>
                            <div class="form-group">
                                <label>Alamat :</label>
    ...
    <script>
        ...
        function loadDataTable() {
            $('#datatable_serverside').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: '{{ url("master_data/warehouse/datatable") }}',
                    type: 'POST',
                    headers: {
        ...
        function create() {
            $.ajax({
                url: '{{ url("master_data/warehouse/create") }}',
                type: 'POST',
                dataType: 'JSON',
        ...
        function show(id) {
            toShow();
            $.ajax({
                url: '{{ url("master_data/warehouse/show") }}',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    id: id
        ...
        function update(id) {
            $.ajax({
                url: '{{ url("master_data/warehouse/update") }}' + '/' + id,
                type: 'POST',
                dataType: 'JSON',
                data: new FormData($('#form_data')[0]),
                processData: false,
        ...
        function destroy(id) {
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        url: '{{ url("master_data/warehouse/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
