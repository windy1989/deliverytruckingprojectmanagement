                    ...
                    <p class="modal-text">
                        ...
                        <form id="form_data">
                            <div class="form-group">
                                <label>Kode :</label>
                                <input type="text" name="code" id="code" class="form-control" placeholder="Auto Generate" disabled>
                            </div>
                            <div class="form-group">
                                <label>Nama :</label>
    ...
    <script>
        ...
        function loadDataTable() {
            $('#datatable_serverside').DataTable({
                ...
                scrollX: true,
                ajax: {
                    url: '{{ url("master_data/vendor/datatable") }}',
                    type: 'POST',
                    headers: {
        ...
        function create() {
            $.ajax({
                url: '{{ url("master_data/vendor/create") }}',
                type: 'POST',
                dataType: 'JSON',
        ...
        function show(id) {
            toShow();
            $.ajax({
                url: '{{ url("master_data/vendor/show") }}',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    id: id
        ...
        function update(id) {
            $.ajax({
                url: '{{ url("master_data/vendor/update") }}' + '/' + id,
                type: 'POST',
                dataType: 'JSON',
                data: $('#form_data').serialize(),
                headers: {
        ...
        function destroy(id) {
            swal({
                ...
                if(result.value) {
                    $.ajax({
                        url: '{{ url("master_data/vendor/destroy") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            id: id
